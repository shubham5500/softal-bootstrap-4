...
<section class="panel_section_1">
	<div class="container">
		<div class="row py-5">			
			<div class="col-md-8">
				<div class="panel_card_first other_one">
					<div class="panel_card_head short_list_head text-center">
						<h2 class="text-white text-uppercase position-absolute">SHORT LIST</h2>
					</div>
					<div class="outer_table py-5 mx-1" id="scroll-bold">
						<?php for($y = 0; $y <= 10; $y++) { ?>
						<div class="text-default fw-500 mb-4 px-3">
							Project #1 | Lorem Ipsum
						</div>
						<div class="panel_card_content short_list row mx-3 mt-3 mb-5" id="scroll-bold">
							<table class="table short_list_table" >
							  <thead>
							    <tr>
			...
			<div class="col-md-4">
				<div class="row panel_card_second">
					<div class="col-md-11 mx-auto mb-4">
						<div class="panel_card_second_1 height_205 row p-4">
					...
					<div class="col-md-11 mx-auto mb-4">
						<div class="panel_card_second_2 height_205 row p-4">
							<div class="col-md-9 p-0 pt-2">
								<p class="text-default name pl-2">Lorem Ipsum</p>
					...
					<div class="col-md-11 mx-auto mb-2">
						<div class="panel_card_second_3 height_360 row p-4">
							<div class="col-md-9 p-0 pt-2">
								<p class="text-default name pl-2">Lorem Ipsum</p>
