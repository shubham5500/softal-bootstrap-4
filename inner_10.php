			...
			<div class="col-md-8">
				<div class="panel_card_first">
					<div class="panel_card_head text-center">
						<h2 class="text-white text-uppercase position-absolute">SAVED JOBS</h2>
					</div>
					<div class="panel_card_content saved_user row m-3" id="scroll-bold">
						<table class="table saved_user_table" >
						  <thead>
						    <tr>
